...
const SCRIPT: [number, CrewEvent][] = [
  ...
  [12.2, S('Critic', 'agent', 'working', 'Reviewing the day')],
  [15.0, S('Critic', 'agent', 'done', 'Approved')],
  [15.2, S('Narrator', 'agent', 'working', 'Writing 5 pages')],
  [17.0, S('Auditor', 'tool', 'working', 'Tracing every sentence')],
