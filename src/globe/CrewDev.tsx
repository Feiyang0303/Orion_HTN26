...
const SCRIPT: [number, CrewEvent][] = [
  ...
  [18.5, S('Auditor', 'tool', 'working', 'Tracing every sentence')],
  [20.0, S('Auditor', 'tool', 'failed', 'Louvre: 2 statements not in the source')],
  [20.1, { type: 'verdict', judge: 'Auditor', scope: 'louvre', ok: false, issues: [{ id: 'a1', text: 'Louvre: the glass pyramid was finished in 1989.', owner: 'Narrator' }] }],
  [21.0, S('Auditor', 'tool', 'done', 'Louvre: all 4 traced after the rewrite')],
  [21.1, { type: 'verdict', judge: 'Auditor', scope: 'louvre', ok: true, issues: [] }],
