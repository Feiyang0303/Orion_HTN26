...
const legs: Leg[] = [
  ...
  // Drawn as a ride so the harness shows one: the geometry is the walk's, the line and stations are the 7's.
  { fromStopId: "pont-neuf", toStopId: "louvre", distanceM: 847, durationSec: 676, transport: 'transit', estimated: false,
    how: 'the 7 subway from Pont Neuf to Palais Royal - Musée du Louvre (1 stop)',
    steps: [
      { mode: 'walk', distanceM: 140 },
      { mode: 'transit', distanceM: 520, line: { name: '7', vehicle: 'subway', colour: '#fa9aba', textColour: '#000000' }, from: 'Pont Neuf', to: 'Palais Royal - Musée du Louvre', stops: 1 },
      { mode: 'walk', distanceM: 187 },
    ],
...
export const mockPlan: Plan = {
  ...
  wish: {
    ...
    party: 'solo', budget: 'modest', meals: [], days: 1, diet: '',
  },
